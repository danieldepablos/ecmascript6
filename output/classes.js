...
function (_Usuario) {
  ...
  function Estudiante(nombre, edad, carrera) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Estudiante).call(this, nombre, edad));
...
var daniel = new Usuario('Daniel Depablos', 44);
var alison = new Estudiante('Alison Depablos', 22, 'Diseño Gráfico');
